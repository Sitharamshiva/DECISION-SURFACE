...
plt.contourf(xx, yy, Z, alpha=0.8, cmap=ListedColormap(['white', 'black']))  # Custom colormap
scatter = plt.scatter(X[:, 0], X[:, 1], c=y, edgecolors='k', marker='o', cmap=ListedColormap(['red', 'green']))  # Custom colors for points
